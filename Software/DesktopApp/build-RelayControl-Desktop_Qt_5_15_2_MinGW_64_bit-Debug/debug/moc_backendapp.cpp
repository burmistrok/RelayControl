...
QT_MOC_LITERAL(1, 11, 21), // "CheckDataFromCommPort"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "BackEndApp\0CheckDataFromCommPort\0"
};
...
void BackEndApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->CheckDataFromCommPort(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BackEndApp::CheckDataFromCommPort)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BackEndApp::CheckDataFromCommPort()
{
